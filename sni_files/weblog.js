...
goServer = src_path.substring(7);
var idx_server_end = goServer.indexOf("/",goServer);
goServer = goServer.substring(0,idx_server_end);
...
src2.src = 'http://'+goServer+'/weblog_ubp.html?uid='+doc_uid;
